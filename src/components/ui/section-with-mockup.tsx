...
const SectionWithMockup: React.FC<SectionWithMockupProps> = ({
  ...
  return (
    <section className="relative py-12 md:py-16 bg-transparent overflow-hidden">
      <div className="container max-w-[1220px] w-full px-6 md:px-10 relative z-10 mx-auto mt-8 md:mt-12">
        <motion.div
        ...
        >
          ...
          >
            <div className="space-y-2 md:space-y-1">
              <h2 className="text-cyber-cyan-bright text-3xl md:text-[40px] font-command font-semibold leading-tight md:leading-[53px]">
                {title}
              </h2>
            </div>

            <p className="text-gray-300 text-sm md:text-[15px] leading-6 font-body">
              {description}
            </p>
          ...
          >
            ...
            <motion.div
              className={`absolute w-[300px] h-[317px] md:w-[472px] md:h-[500px] bg-war-room-charcoal rounded-[32px] z-0`}
              style={{
            ...
            {/* Main Mockup Card */}
            <motion.div
              className="relative w-full h-[405px] md:h-[637px] bg-cyber-cyan-dim/10 rounded-[32px] backdrop-blur-[15px] backdrop-brightness-[100%] border border-cyber-cyan-dim/30 z-10 overflow-hidden"
              initial={{ y: reverseLayout ? 0 : 0 }}
              whileInView={{ y: reverseLayout ? 20 : 30 }}
